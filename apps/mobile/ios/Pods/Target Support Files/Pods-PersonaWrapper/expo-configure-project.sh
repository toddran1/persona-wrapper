...
with_node \
  ...
  --target "/Users/reginaldrandolph/Documents/coding projects/python/persona_wrapper_app/apps/mobile/ios/Pods/Target Support Files/Pods-PersonaWrapper/ExpoModulesProvider.swift" \
  --entitlement "/Users/reginaldrandolph/Documents/coding projects/python/persona_wrapper_app/apps/mobile/ios/PersonaWrapper/PersonaWrapper.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-constants" "expo-document-picker" "expo-image-picker" "expo-linear-gradient" "expo-linking" "expo-router" "expo-secure-store"
