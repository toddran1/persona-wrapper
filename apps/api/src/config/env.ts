...
const envSchema = z.object({
  ...
  CUSTOMER_USAGE_AUDIO_COST_PER_MINUTE_USD: z.coerce.number().nonnegative().default(0.1),
  CUSTOMER_USAGE_IMAGE_INPUT_COST_USD: z.coerce.number().nonnegative().default(0.01),
