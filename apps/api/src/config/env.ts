...
const envSchema = z.object({
  ...
  OPENAI_AUDIO_MAX_OUTPUT_TOKENS: z.coerce.number().int().positive().default(1230),
  CHAT_AUDIO_MAX_RESPONSE_CHARACTERS: z.coerce.number().int().min(400).max(4800).default(1200),
