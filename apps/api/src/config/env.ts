...
const envSchema = z.object({
  ...
  TERMS_POLICY_VERSION: z.preprocess(optionalTrimmedString, z.string().min(1).max(80).default("2026-09-08.1")),
  PRIVACY_POLICY_VERSION: z.preprocess(optionalTrimmedString, z.string().min(1).max(80).default("2026-09-08.1")),
