...
const envSchema = z.object({
  ...
  CONVERSATION_MEMORY_SUMMARY_AFTER_MESSAGES: z.coerce.number().int().min(4).max(200).default(20),
  CONVERSATION_MEMORY_SUMMARY_MAX_CHARACTERS: z.coerce.number().int().min(500).max(20000).default(3000),
