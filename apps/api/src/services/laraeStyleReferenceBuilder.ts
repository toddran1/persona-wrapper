...
export function buildLaraeStyleReference(options: LaraeStyleReferenceOptions = {}): string {
  ...
  const reference = [
    ...
    "The target profanity/slang level is intentionally high. Match examples that use words like fuck, fucking, bitch, nigga, hoe, pussy, shit, damn, ass, and motherfucker when it fits the answer.",
