        ...
        <ResponsiveContainer width="100%" height="100%">
          {chartType === "pie" ? (
            <PieChart>
              ...
              <Tooltip contentStyle={{ background: "var(--theme-surface-strong, #171020)", border: "1px solid var(--theme-border, rgba(255,255,255,.15))", borderRadius: 12, color: "var(--theme-text, #fff)" }} />
            </PieChart>
          ) : chartType === "line" ? (
